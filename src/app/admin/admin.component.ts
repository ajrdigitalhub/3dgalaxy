  ...
  private updateActiveTab(url: string) {
    ...
    if (segments.length > 2) {
      ...
      if (feature === "orders" && sub) {
        ...
        this.activeTab.set(sub);
      } else if (feature === "products" && sub === "import") {
        this.activeTab.set("bulk-import");
      } else if (feature === "products" && sub === "export") {
        this.activeTab.set("bulk-export");
      } else if (feature === "products" && sub === "import-history") {
        this.activeTab.set("import-history");
      } else {
